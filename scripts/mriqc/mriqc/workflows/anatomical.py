...
def anat_qc_workflow(dataset, mdir, tempdir, name='anatMRIQC'):
...
def airmsk_wf(name='AirMaskWorkflow'):
    ...
    #invt.inputs.field_template = dict(output_image = 'head_mask_registered.nii.gz')
    #invt.inputs.sort_filelist= False
